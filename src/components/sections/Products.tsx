...
const productCategories = [
  ...
  ,
  {
    ...
    description: 'Durable and timeless, our cowhide jackets combine rugged strength with premium style, perfect for those who value authenticity and endurance.',
    image: '/cowhide.jpeg',
